...
?>
<h4 class="font-alt"><?php _e( 'Order Details', 'woocommerce' ); ?></h4>
...
<header>
	<h4 class="font-alt"><?php _e( 'Customer details', 'woocommerce' ); ?></h4>
</header>
...
<?php endif; ?>
		...
		<header class="title">
			<h4 class="font-alt"><?php _e( 'Billing Address', 'woocommerce' ); ?></h4>
		</header>
		<address>
			<?php
...
<?php if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() && get_option( 'woocommerce_calc_shipping' ) !== 'no' ) : ?>
	...
	<div class="col-2">
		...
		<header class="title">
			<h4 class="font-alt"><?php _e( 'Shipping Address', 'woocommerce' ); ?></h4>
		</header>
		<address>
			<?php
